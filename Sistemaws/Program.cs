...
{
    c.SwaggerDoc("v1", new OpenApiInfo { Title = "Sistemaws API", Version = "v1" });
...
// Ensure database is created and initialize with default admin
